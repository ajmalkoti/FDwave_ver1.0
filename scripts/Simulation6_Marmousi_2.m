...
% cvp=ReadSegy('marmousi_vp.segy');
% cvs=cvp./sqrt(3);
% crho=.541 + 0.3601*cvp;
% WriteSegy('marmousi_vp.segy',cvp);
% WriteSegy('marmousi_vs.segy',cvs);
% WriteSegy('marmousi_rho.segy',crho);
...
%source
FDwave_source_ricker('WFP',wf_path,'T',2,'DT',.00025,'F0',15,'T0',0.06,'PlotON','y');
...
FDwave_calculation_plot('wfp',wf_path,'SSFileName',str,'scale',3)
...
export_fig fig6_marmousi_model/marmousi_model.fig -pdf
export_fig fig6_marmousi_model/marmousi_SS.fig -pdf
