...
model_build_shape_arbitrary('WFP',wf_path,'coord',CVec,'VP',2500,'VS',2000,'RHO',1800,'plotON','n');
% Create second dipping layer (at greater depth).
CVec={[1,200],[500,400],[500,400],[1,400],[1,200]};
model_build_shape_arbitrary('WFP',wf_path,'coord',CVec,'VP',2800,'VS',2200,'RHO',2000,'plotON','n');
% Plot the final model.
model_plot('WFP',wf_path)

%source
FDwave_source_ricker('WFP',wf_path,'T',1.5,'DT',.00025,'F0',20,'T0',0.07,'PlotON','y');
...
FDwave_calculation_plot('wfp',wf_path,'SSFileName',str,'scale',2)
